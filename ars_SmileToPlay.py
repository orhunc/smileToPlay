...
global smile_sizes, consecutive_angry, consecutive_suprises, consecutive_happy, smileQuality, fakeness
suprises_count = 0
...
#delays = [41,36,33, 52, 33, 34 ,63, 54, 12, 36, 36, 36, 36]
delays = [39,31,32, 50, 30, 32 ,60, 51, 11, 36, 36, 36, 36]
...
def video_processing():
    global eval, end_time, noSmile, smileQuality, fakeness, section, last_time, end, last_section, last_change_time, consecutive_smiles, pred, emotion_timer, happiness_predictions, current_pred, previous_pred, consecutive_suprises, consecutive_angry, consecutive_happy, smile_sizes
    ...
    while not stop_event.is_set():
        ...
        for (x, y, w, h) in faces:
            ...
            if time.time() - emotion_timer >= 0.6:
