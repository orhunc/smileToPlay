...
class Video:
    ...
    def has_ended(self):
        ...
        :return: Returns True if the video has ended, else False.
        """
        tmp = False
        
        #print(self.duration)
        #print(self._video.get_pts())
        if self._video.get_pts() >= (self.duration - 1):
           tmp = True
           print('restarting')
        
        #tmp = self._video.get_pts() > self._frame_num * self.frame_delay
        return tmp
